...
public class BLEService1 extends Service {
    ...
    private BLEService1 mContext;// 上下文
...
//		mBluetoothAdapter = BluetoothAdapter.getDefaultAdapter();
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt,
            ...
            String recv = new String(characteristic.getValue());
            sendDataBroadcast(recv, deviceAddress);
            System.out.println("我收到了" + deviceAddress + "的数据:" + recv);
        }
