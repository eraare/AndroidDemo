...
/**
 * @author Leo
 * @detail 类似于雷达扫描的控件 具有开始 扫描 成功 失败三种状态
 * @time 2016-01-14
 */
public class RadarView extends View {
    ...
    private int circleColor = Color.parseColor("#C6C6C6");
    private int radarColor = Color.parseColor("#3DBD77");
    private int tailColor = Color.parseColor("#3DBD77");
